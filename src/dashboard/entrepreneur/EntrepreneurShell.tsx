...
type EntrepreneurShellContextValue = {
  sidebarOpen: boolean
}

export const EntrepreneurShellContext = createContext<EntrepreneurShellContextValue>({
  sidebarOpen: false,
})
...
export default function EntrepreneurShell({
  ...
  return (
    <EntrepreneurShellContext.Provider value={{ sidebarOpen }}>
      <main style={styles.root}>
        ...
        >
          ...
          <div
            ...
            style={{
              ...styles.contentArea,
              filter: sidebarOpen ? 'blur(1.5px)' : 'none',
              opacity: sidebarOpen ? 0.9 : 1,
              transform: sidebarOpen ? 'scale(0.997)' : 'none',
              pointerEvents: 'auto',
              userSelect: 'auto',
    ...
    </EntrepreneurShellContext.Provider>
  )
}
